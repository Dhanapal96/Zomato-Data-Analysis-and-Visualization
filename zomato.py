...
data = pd.read_csv(r'C:\Users\dhanapal\ML Folder\cleaned_zomato_dataset.csv')
...
def generate_pdf_report(country_name, insights, chart_data=None):
    ...
    pdf.drawString(50, 750, f"Report for {country_name}")  
    ...
    for insight in insights:
        pdf.drawString(50, y_position, f"- {insight}")  
        y_position -= 50  
